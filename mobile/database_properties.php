...
<form name="form1" method="post" action="table_export.php">
<table width="<?php echo($_SETTINGS['mobilescreenwidth']); ?>" cellpadding="2" cellspacing="0" style="border: 1px solid">
	<tr>
		...
		<td align="center" colspan="6" style="background: #D0DCE0">
			<b>Action</b>
		</td>
		<td align="center" style="background: #D0DCE0">
			<b>Records</b>
	...
	<?php
		...
		foreach($tables AS $row)
		{
			...
			echo '<tr>';
			echo('<td align="center" style="background: ' . $bg . '" nowrap><input type="checkbox" name="tables[]" value="' . urlencode($row) . '"></td>');
			echo('<td style="background: ' . $bg . '" nowrap>&nbsp;' . $row . '</td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="table_browse.php?table=' . urlencode($row) . '">Browse</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="table_select.php?table=' . urlencode($row) . '">Select</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="table_insert.php?table=' . urlencode($row) . '">Insert</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="table_properties.php?table=' . urlencode($row) . '">Properties</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="trigger_list.php?table=' . urlencode($row) . '">Triggers</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="table_drop.php?table=' . urlencode($row) . '">Drop</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="table_empty.php?table=' . urlencode($row) . '">Empty</a></td>');
			echo('<td style="background: ' . $bg . '" nowrap>' . number_format($records) . '</td>');
			echo '</tr>';

			unset($column_query,$column_array,$column,$record_query,$record_array,$records);
		}
	?>
	<tr>
	...
	<tr>
		<td align="center" colspan="9" style="background: #D0DCE0">
...
<table width="<?php echo($_SETTINGS['mobilescreenwidth']); ?>" cellpadding="2" cellspacing="0" style="border: 1px solid">
	...
	<tr>
		<td align="left" style="background: #CCCCCC" nowrap>
			<input type="radio" name="operation" value="export" onclick="javascript:document.form1.action = 'table_export.php';" checked>&nbsp;Export Data from Selected Table's<br>
...
<table width="<?php echo($_SETTINGS['mobilescreenwidth']); ?>" cellpadding="2" cellspacing="0" style="border: 1px solid">
	...
	<?php
		...
		foreach($procs AS $key => $value)
		{
			...
			echo '<tr>';
			echo('<td align="center" style="background: ' . $bg . '" nowrap><input type="checkbox" name="procedures[]" value="' . $row['Name'] . '"></td>');
			echo('<td style="background: ' . $bg . '" nowrap>&nbsp;' . $row['Name'] . '</td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="procedure_execute.php?procedure=' . urlencode($row['Name']) . '">Execute</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="procedure_modify.php?procedure=' . urlencode($row['Name']) . '">Modify</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="procedure_drop.php?procedure=' . urlencode($row['Name']) . '&returnto=database_properties.php">Drop</a></td>');
			echo '</tr>';
...
<table width="<?php echo($_SETTINGS['mobilescreenwidth']); ?>" cellpadding="2" cellspacing="0" style="border: 1px solid">
	...
	<?php
		...
		foreach($views AS $key => $value)
		{
			...
			echo '<tr>';
			echo('<td align="center" style="background: ' . $bg . '" nowrap><input type="checkbox" name="views[]" value="' . $row['Name'] . '"></td>');
			echo('<td style="background: ' . $bg . '" nowrap>' . $row['Name'] . '</td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="table_select.php?view=' . urlencode($row['Name']) . '">Select</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="view_modify.php?view=' . urlencode($row['Name']) . '">Modify</a></td>');
			echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="view_drop.php?view=' . urlencode($row['Name']) . '&returnto=database_properties.php">Drop</a></td>');
			echo '</tr>';
