...
<form name="form1" method="post" action="procedure_list.php">
	...
	<?php
		...
		while($row = mssql_fetch_assoc($proc_query))
		{
			if($row['Object_type'] == 'stored procedure' && ($row['Owner'] == 'dbo' || $_SETTINGS['showsysdata']))
			{
				...
				echo('<td align="center" style="background: ' . $bg . '" nowrap><a href="procedure_drop.php?procedure=' . urlencode($row['Name']) . '&returnto=procedure_list.php">Drop</a></td>');
				echo '</tr>';
